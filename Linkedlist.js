class Linkedlist {
    ...
    prepend(value) {
        const newnode = { value: value, next: null } //it creates an  value it's our existing ll (12|.->23|.->null) add an value
    ...
    insert(index, value) {
        ...
        const newnode = { value: value, next: null } //created a new node
    ...
    removebyIndex(index) {
        ...
        let removeditem = header.next //js is a high level lang. it has a automatic garbage collector whenever we change our ref value it's automatically deleted.
        header.next = removeditem.next
        this.length -= 1
        return this.printlist()
